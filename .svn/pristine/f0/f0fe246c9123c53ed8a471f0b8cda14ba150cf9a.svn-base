...
int	SessionHandler::RegisterIoEvent(short what)
{
	if (NULL == m_kEventType[ET_RW])
		m_kEventType[ET_RW] = event_new(GetEventBase(), GetHandleFd(), what, &SessionHandler::ProcessOpreation_cb, (void*)this);
	else
		event_assign(m_kEventType[ET_RW], GetEventBase(), GetHandleFd(), what, &SessionHandler::ProcessOpreation_cb, (void*)this);			
...
int SessionHandler::RegisterTimeEvent(timeval &tv)
{
	if (NULL == m_kEventType[ET_TIME])
		m_kEventType[ET_TIME] = event_new(GetEventBase(), GetHandleFd(), EV_TIMEOUT, &SessionHandler::ProcessOpreation_cb, (void*)this);
	else
		event_assign(m_kEventType[ET_TIME], GetEventBase(), GetHandleFd(), EV_TIMEOUT, &SessionHandler::ProcessOpreation_cb, (void*)this);			
